...
Por fim, a interface IFusionTable é utilizada para submeter os valores das métricas relacionadas e-Participação a uma Fusion Table \cite{eParticipationMetrics}, via a API do Google Fusion Tables; e também os relacionalidos as polaridades de sentimentos, processados pelas aplicações explicadas em \ref{sparkApp} e \ref{stormApp}. Os valores dessa tabela são utilizados para criar o mapa contido na aplicação web.
